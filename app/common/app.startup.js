(function() {
    ...
    angular.module("app.common").
        ...
        run(["$translate", "blockUIConfig", "pageService", "apiService", "parametroService", startup]);
    ...
    function startup($translate, blockUIConfig, pageService, apiService, parametroService) 
    {
